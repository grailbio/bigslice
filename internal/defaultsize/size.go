...
var (
	...
	// It's part of a temporary solution; see go/go/bigslice-chunk-thread.
	Chunk      int
...
func init() {
	flag.IntVar(&Chunk, "bigslice-internal-default-chunk-size", 1024,
		"Default vector size to use internally. Temporary; see go/bigslice-chunk-thread")
	flag.IntVar(&SortCanary, "bigslice-internal-default-sort-canary-size", 1<<14,
